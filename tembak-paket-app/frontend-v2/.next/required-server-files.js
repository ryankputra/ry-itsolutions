  ...
  "config": {
    ...
    "_originalRewrites": {
      ...
      "afterFiles": [
        {
          "source": "/create-qris",
          "destination": "http://127.0.0.1:3002/create-qris"
        },
        {
          "source": "/check-payment",
          "destination": "http://127.0.0.1:3002/check-payment"
        },
        {
          "source": "/qr/:path*",
          "destination": "http://127.0.0.1:3002/qr/:path*"
        },
        {
        ...
        },
        {
          ...
          "destination": "http://127.0.0.1:3001/public/uploads/:path*"
        }
      ],
      "fallback": []
    }
