"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[210],{1822:(e,a,r)=>{r.d(a,{AppProvider:()=>d,n:()=>l});var t=r(5155),n=r(2115),s=r(7529);let o="menu_settings",i={showBeliPaket:!1},c=(0,n.createContext)(void 0);function d({children:e}){let[a,r]=(0,n.useState)(null),[l,p]=(0,n.useState)(!0),[u,f]=(0,n.useState)(()=>{try{let e=window.localStorage.getItem(o);return e?{...i,...JSON.parse(e)}:i}catch{return i}}),[x,m]=(0,n.useState)({cekCeir:[],barcode:[]}),b=e=>{f(e),window.localStorage.setItem(o,JSON.stringify(e)),window.dispatchEvent(new CustomEvent("menu_settings_updated",{detail:e}))};return(0,n.useEffect)(()=>{!async function(){try{let[e,a,t]=await Promise.all([fetch(`${s.H$}/auth/me`,{credentials:"include"}).catch(()=>null),fetch(`${s.H$}/admin/menu-settings`,{credentials:"include"}).catch(()=>null),fetch(`${s.H$}/admin/ceirgo-display-settings`,{credentials:"include"}).catch(()=>null)]);if(e&&e.ok){let a=await (0,s.oi)(e);a&&a.status&&a.user&&r(a.user)}if(a&&a.ok){let e=await (0,s.oi)(a);e&&e.status&&b({showBeliPaket:!!e.data?.showBeliPaket})}if(t&&t.ok){let e=await (0,s.oi)(t);e&&e.status&&m({cekCeir:Array.isArray(e.data?.cekCeir)?e.data.cekCeir:[],barcode:Array.isArray(e.data?.barcode)?e.data.barcode:[]})}}catch(e){console.error("Failed to load initial data:",e)}finally{p(!1)}}()},[]),(0,n.useEffect)(()=>{if(!a)return;let e=new EventSource(`${s.H$}/stream`,{withCredentials:!0});return e.addEventListener("balance_update",e=>{try{let a=JSON.parse(e.data);"number"==typeof a.balance&&(r(e=>e?{...e,balance:a.balance}:null),window.dispatchEvent(new CustomEvent("topup_success")))}catch(e){}}),()=>e.close()},[a]),(0,t.jsx)(c.Provider,{value:{user:a,loading:l,menuSettings:u,ceirgoDisplaySettings:x,setUser:r,updateBalance:e=>{r(a=>a?{...a,balance:e}:null)},updateMenuSettings:b,updateCeirgoDisplaySettings:e=>{m(e)}},children:e})}function l(){let e=(0,n.useContext)(c);if(void 0===e)throw Error("useApp must be used within AppProvider");return e}},3321:(e,a,r)=>{var t=r(4645);r.o(t,"redirect")&&r.d(a,{redirect:function(){return t.redirect}}),r.o(t,"usePathname")&&r.d(a,{usePathname:function(){return t.usePathname}}),r.o(t,"useRouter")&&r.d(a,{useRouter:function(){return t.useRouter}}),r.o(t,"useSearchParams")&&r.d(a,{useSearchParams:function(){return t.useSearchParams}})},4037:(e,a,r)=>{r.d(a,{Z:()=>n});var t=r(5155);function n({children:e,className:a="",glass:r,...s}){return(0,t.jsx)("div",{className:`${r?"rounded-[18px] border border-hairline bg-parchment/80 backdrop-blur-md p-6":"rounded-[18px] border border-hairline bg-canvas p-6"} ${a}`,...s,children:e})}r(2115)},4327:(e,a,r)=>{r.d(a,{$:()=>n});var t=r(5155);function n({children:e,variant:a="primary",size:r="md",isLoading:s,className:o="",disabled:i,...c}){return(0,t.jsxs)("button",{className:`inline-flex items-center justify-center font-normal transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-focus disabled:pointer-events-none disabled:opacity-50 active:scale-[0.95] ${{primary:"bg-primary text-white hover:bg-primary-focus rounded-full shadow-none",secondary:"bg-transparent text-primary border border-primary rounded-full hover:bg-primary/5",outline:"border border-hairline bg-transparent hover:bg-parchment text-ink rounded-lg",ghost:"hover:bg-parchment text-ink rounded-lg",danger:"bg-red-500/10 text-red-500 hover:bg-red-500/20 rounded-lg",pearl:"bg-surface-pearl text-ink-muted border-[3px] border-divider rounded-[11px] hover:bg-divider"}[a]} ${{sm:"h-9 px-4 text-xs",md:"h-11 px-6 text-sm",lg:"h-14 px-8 text-base"}[r]} ${o}`,disabled:s||i,...c,children:[s?(0,t.jsxs)("svg",{className:"animate-spin -ml-1 mr-2 h-4 w-4 text-current",xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[(0,t.jsx)("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),(0,t.jsx)("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}):null,e]})}r(2115)},6987:(e,a,r)=>{r.d(a,{D:()=>s});var t=r(5155),n=r(2115);function s({isOpen:e,onClose:a,amount:r,title:o="Pembayaran Berhasil",statusText:i="Pesanan Anda telah berhasil dibuat!",recipientLabel:c="Tujuan",recipientValue:d,methodValue:l="Saldo Ry-ITSolutions"}){return((0,n.useEffect)(()=>(e?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[e]),e)?(0,t.jsxs)("div",{className:"fixed inset-0 z-[999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4",children:[(0,t.jsx)("style",{dangerouslySetInnerHTML:{__html:`
        .app-screen {
          position: relative;
          width: 100%;
          max-width: 380px;
