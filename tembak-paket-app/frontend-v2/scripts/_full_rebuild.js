...
// Karena kode sangat panjang dan rentan rusak karena kutip/backtick di string replace Node,
// saya akan mengambil template utuh dari file lokal jika bisa. Namun kita tahu file aslinya sudah rusak.

// Tulis manual dengan sangat hati-hati:
...
fs.writeFileSync('src/app/(main)/admin/page.tsx', code);
console.log('Fixed');