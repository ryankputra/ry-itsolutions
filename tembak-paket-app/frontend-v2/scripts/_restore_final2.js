...
export default function AdminPage() {
  ...
  const [showOnlyPendingManual, setShowOnlyPendingManual] = useState(true);
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert('Sinkronisasi KMSP berhasil!');
  ...
  const handleUpdateBalance = async (userId: number) => {
    ...
    } catch (e) { alert("Error update balance"); }
  };
  ...
  const handleSaveAnnouncement = async () => {
    ...
    try {
      ...
      if (res.ok) alert("Pengumuman disimpan!");
    } finally { setSavingAnn(false); }
  };

  if (userLoading) return <p className="p-6 text-sm text-ink-muted">Memuat Admin Panel...</p>;
  ...
  if (selectedPkgIndex !== null && selectedPkgIndex >= 0 && selectedPkgIndex < packages.length) {
    selectedPkg = packages[selectedPkgIndex];
  }
            ...
            <div className="pt-4 border-t border-hairline space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input 
                  ...
                  onChange={(e) => {
                    if (selectedPkgIndex !== null && selectedPkgIndex >= 0) {
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    <select 
                      ...
                      onChange={async (e) => {
                        ...
                        } catch(err) { alert("Error ubah role"); }
                      }}
                    >
                    ...
                    {selectedUserId === u.id ? (
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" onClick={() => handleUpdateBalance(u.id as any)}>Add</Button>
                    ...
                    <Button variant="danger" size="sm" onClick={async () => {
                      ...
                      try {
                        ...
                        if(res.ok) loadUsers();
                        else alert("Gagal hapus, mungkin anda menghapus diri sendiri.");
                      } catch(e) { alert("Error"); }
                    }}>Hapus</Button>
                  </div>
                </div>
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={async () => {
                  try {
                    ...
                    if (res.ok) alert("Harga layanan Ceirgo berhasil disimpan!");
                  } catch(e) { alert("Error menyimpan harga"); }
          ...
          <Card glass className="p-6 space-y-4">
            <div className="flex justify-between items-center flex-wrap gap-4">
              <h2 className="text-xl font-bold">Antrean Pesanan Manual (Legacy)</h2>
          ...
          <Card glass className="p-6 space-y-6">
            <h2 className="text-xl font-bold">Paket Unblock IMEI</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 items-end pt-2">
                ...
                <Button className="h-10 shrink-0" onClick={async () => {
                  if (!newImeiPkg.duration || !newImeiPkg.price) return alert("Isi durasi dan harga");
            ...
            <div className="pt-4 border-t border-hairline space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-canvas border border-hairline p-3 rounded-xl space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-sm">🚀 Semi Fast</span>
            ...
            <Button onClick={async () => {
              try {
                ...
                if(res.ok) alert("Harga tersimpan!");
              } catch(e) {}
      ...
      {activeTab === 'pengaturan' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card glass className="p-6 space-y-4">
              <h2 className="text-xl font-bold">Tampilan Menu User</h2>
              <p className="text-sm text-ink-muted">Sembunyikan menu yang belum siap rilis.</p>
              <div className="flex justify-between items-center p-4 bg-canvas border border-hairline rounded-xl">
                <div>
                  ...
                  <p className="text-xs text-ink-muted">Paket Data, Pulsa, dll</p>
                </div>
                <button onClick={async () => {
                ...
                }} className={\`px-3 py-1.5 text-xs font-bold rounded-lg transition-colors \${menuSettings?.showBeliPaket ? 'bg-green-100 text-green-700' : 'bg-slate-200 text-slate-600'}\`}>
              ...
              <Button 
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const data = await res.json();
                    if (res.ok && data.status) alert(data.message);
                    else alert(data.message || 'Gagal menyimpan');
                  } catch (e) { alert('Error menyimpan gateway'); }
