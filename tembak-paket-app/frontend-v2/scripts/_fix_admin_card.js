...
const regex = /<Card glass className="p-6 space-y-4">\s*<div className="flex justify-between items-center flex-wrap gap-4">\s*<h2 className="text-xl font-bold">Antrean Pesanan Manual<\/h2>[\s\S]*?<\/Card>/m;

const replacement = \`<Card glass className="p-6 space-y-4">
