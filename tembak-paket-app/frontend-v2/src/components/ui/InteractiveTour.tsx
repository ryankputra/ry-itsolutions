...
const DEFAULT_STEPS: TourStep[] = [
  {
    ...
    title: "Dompet Saldo & Top Up Instan",
    badge: "Sat-Set 1",
    description: "Halo guys! Ini dompet saldo kamu nih. Mau top up? Gak pake ribet, langsung scan QRIS 24 jam dan saldo auto masuk detik itu juga. No drama nunggu admin!",
  ...
  },
  {
    ...
    title: "Pencarian Cepat Sat-Set",
    badge: "Sat-Set 2",
    description: "Nah, ini fitur search sat-set! Tinggal tempel 15 digit IMEI atau ID order kamu, sistem bakal langsung spill status sinyal dan tipe HP kamu dalam sekejap.",
  ...
  },
  {
    ...
    badge: "Gaspol 3",
    description: "Mau unblock sinyal HP inter all operator? Gas di menu ini! Masukkan IMEI, upload foto *#06#, pilih durasi, dan sinyal kamu langsung on lagi.",
  ...
  },
  {
    ...
    title: "Kepoin Database CEIR & Bea Cukai",
    badge: "Cek Dulu 4",
    description: "Sebelum eksekusi, kamu bisa kepoin dulu status IMEI di database CEIR dan Bea Cukai lewat menu ini. Dijamin akurat dan transparan!",
  ...
  },
  {
    ...
    title: "Garansi Digital Anti Galau",
    badge: "Aman 5",
    description: "Tenang aja, semua order di sini ada garansi resminya lho! Kamu bisa cek sisa garansi, download nota PDF, atau chat bantuan teknis kapan aja.",
  ...
  },
  {
    ...
    title: "Pusat Klaim Voucher Cuan",
    badge: "Surganya Diskon",
    description: "Ini dia surganya diskon! Klaim semua voucher promo spesial di sini sekarang sebelum kehabisan kuota, terus langsung pasang pas checkout biar makin hemat dan cuan!",
  ...
  },
  {
    ...
    title: "Referral Cuan Pasif",
    badge: "Auto Cuan",
    description: "Mau dapet cuan pasif tiap hari? Share link referral kamu ke temen-temen. Tiap kali mereka order, komisi saldo langsung ngalir ke akun kamu. Auto cuan maksimal!",
