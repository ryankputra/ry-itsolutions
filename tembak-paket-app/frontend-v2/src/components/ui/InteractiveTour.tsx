...
const DEFAULT_STEPS: TourStep[] = [
  {
    ...
    title: "Pusat Saldo & Top Up Otomatis",
    badge: "Langkah 1",
    description: "Pusat kendali saldo Anda. Lakukan top up otomatis 24 jam via QRIS Nasional, saldo langsung bertambah seketika dalam hitungan detik tanpa menunggu konfirmasi manual.",
  ...
  },
  {
    ...
    badge: "Langkah 2",
    description: "Ketik atau tempelkan 15 digit nomor IMEI ataupun ID transaksi Anda, sistem akan mendeteksi status sinyal, tipe perangkat, dan riwayat pesanan secara instan.",
  ...
  },
  {
    ...
    badge: "Langkah 3",
    description: "Layanan unggulan aktivasi sinyal HP luar negeri all operator. Masukkan nomor IMEI, unggah verifikasi *#06#, dan tentukan durasi masa aktif yang Anda butuhkan.",
  ...
  },
  {
    ...
    badge: "Langkah 4",
    description: "Pemeriksaan resmi database CEIR dan Bea Cukai. Pastikan histori registrasi dan legalitas perangkat Anda terverifikasi sebelum melakukan aktivasi sinyal.",
  ...
  },
  {
    ...
    badge: "Langkah 5",
    description: "Perlindungan garansi digital terpadu. Pantau sisa masa aktif garansi, unduh nota transaksi resmi PDF, dan ajukan bantuan teknis prioritas kapan pun.",
  ...
  },
  {
    ...
    badge: "Diskon Cuan",
    description: "Ambil berbagai kupon potongan harga spesial sebelum kuota klaim habis, dan pasang langsung saat checkout pesanan untuk menikmati diskon instan!",
  ...
  },
  {
    ...
    badge: "Bonus Pasif",
    description: "Bagikan tautan referral eksklusif Anda ke rekan atau pelanggan, dan raih komisi saldo otomatis tanpa batas di setiap transaksi pengguna baru.",
