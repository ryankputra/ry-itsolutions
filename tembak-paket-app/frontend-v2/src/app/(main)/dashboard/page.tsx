...
export default function DashboardPage() {
  ...
  const heroSlides = [
    ...
    {
      title: "PENDAFTARAN & CEK STATUS CEIR",
      subtitle: "Verifikasi status CEIR resmi Kemenperin & pendaftaran Bea Cukai perangkat Anda.",
      badge: "CEIR RESMI",
      ctaText: "CEK STATUS >",
      ctaLink: "/cek-ceir",
      bgGradient: "from-emerald-950/90 via-teal-950/80 to-transparent",
      image: "/banners/banner_ceir.jpg",
    },
    {
      title: "GARANSI & NOTA DIGITAL RESMI",
      subtitle: "Lacak sisa masa aktif garansi IMEI dan unduh cetak nota transaksi kapan saja.",
      badge: "GARANSI AKTIF",
      ctaText: "CEK GARANSI >",
      ctaLink: "/cek-garansi",
      bgGradient: "from-indigo-950/90 via-slate-900/80 to-transparent",
      image: "/banners/banner_garansi.jpg",
    },
    {
      title: "AJAK TEMAN & DAPATKAN KOMISI",
      subtitle: "Bagikan link referral Anda dan peroleh komisi saldo otomatis dari tiap transaksi.",
      badge: "BONUS REFERRAL",
      ctaText: "KLAIM CUAN >",
      ctaLink: "/referral",
      bgGradient: "from-amber-950/90 via-orange-950/80 to-transparent",
      image: "/banners/banner_referral.jpg",
    },
    {
      ...
      ctaLink: "/vouchers",
      bgGradient: "from-purple-950/90 via-indigo-900/80 to-transparent",
  ...
  const toggleShowBalance = (e?: React.MouseEvent | React.TouchEvent) => {
    ...
    if (typeof window !== "undefined") {
      ...
      window.dispatchEvent(new CustomEvent("balance_visibility_changed", { detail: nextState }));
    }
  };
  ...
  return (
    <div className="space-y-4 max-w-7xl mx-auto pb-16">
      {/* Promo Announcement Popup Modal (Mobile & Desktop) */}
      <PromoPopupModal />
            ...
            >
              ...
              <div className="mt-1 flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full flex items-center justify-center text-ink-muted hover:text-ink hover:bg-canvas/80 active:scale-90 transition-all cursor-pointer shrink-0"
          ...
          >
            ...
            <div className="mt-1 flex items-center justify-center gap-1">
              ...
              <button
                ...
                onClick={toggleShowBalance}
                aria-label={showBalance ? "Sembunyikan Saldo" : "Tampilkan Saldo"}
                className="w-7 h-7 rounded-full flex items-center justify-center text-ink-muted hover:text-ink hover:bg-canvas/80 active:scale-90 transition-all cursor-pointer shrink-0"
                title={showBalance ? "Sembunyikan Saldo" : "Tampilkan Saldo"}
              >
                {showBalance ? (
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
