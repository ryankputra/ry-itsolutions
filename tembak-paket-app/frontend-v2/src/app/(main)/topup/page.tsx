            ...
            {gatewayInfo && !gatewayInfo.is_ready && (
              <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-900 dark:text-amber-200 text-xs space-y-2">
                ...
                <p className="text-[11px] leading-relaxed text-amber-700 dark:text-amber-300/80">
                  {gatewayInfo.message || "Sesi pembayaran otomatis GoPay sedang tidak aktif / belum disiapkan admin. Silakan hubungi CS Admin untuk deposit saldo manual via WhatsApp."}
                </p>
                <div className="pt-1 flex gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#25D366] hover:bg-emerald-600 text-white font-bold text-[11px] transition-colors shadow-xs"
                  >
